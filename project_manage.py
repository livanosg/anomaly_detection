...
from config import TRIALS_DIR, CLASS_NAMES, INPUT_SHAPE, BATCH_SIZE, LEARNING_RATE, EPOCHS, SEED


class Config:

    def __init__(self, method="supervised", trial_id=None, class_names=CLASS_NAMES,
        ...
        self.train_conf = {"method": self.method,
        ...
        self.dataset_conf = {"class_names": class_names,
